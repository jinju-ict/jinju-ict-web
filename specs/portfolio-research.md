# 진주 정보통신개발 포트폴리오 리서치 (vision-intake 백그라운드 산출)

## 1. TtokTtok

- **분류**: 진주 정보통신개발 자체 (상용 준비 중)
...
- **분류**: 진주 정보통신개발 내부 개발 인프라 (서비스명 추상화 금지)
...
- **인사이트 (이 사이트를 만들 때 참고할 것)**:
  - 진주 정보통신개발 사이트도 **국제화 구조 권장**(한국어+영문)
